...
const LoginPage: React.FC<LoginPageProps> = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen bg-[#FFFAF3] flex items-center justify-center p-6 relative overflow-hidden font-sans">
      {/* Decorative Background Elements */}
      <div className="absolute top-0 left-0 w-full h-full -z-10">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-amber-100/40 rounded-full blur-[100px] animate-pulse"></div>
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-orange-100/40 rounded-full blur-[100px] animate-pulse delay-1000"></div>
      </div>
      ...
      <div className="w-full max-w-md bg-white rounded-[2.5rem] shadow-2xl p-8 sm:p-10 border border-white relative">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input 
                ...
                placeholder="admin"
                className="w-full bg-slate-50 border border-slate-200 rounded-2xl py-4 pl-14 pr-5 text-slate-900 focus:outline-none focus:ring-4 focus:ring-amber-500/10 focus:border-amber-500 font-semibold transition-all"
                required
              />
            </div>
          </div>
        ...
        <div className="mt-10 pt-8 border-t border-slate-50 text-center">
          <p className="text-sm text-slate-400 font-medium">
            Sistema administrativo exclusivo para a profissional.
          </p>
        </div>
      </div>
    </div>
